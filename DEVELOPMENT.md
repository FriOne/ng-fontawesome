...
```
|__bundles/
   |__ng-fontawesome.umd.js
   |__ng-fontawesome.umd.js.map
   |__ng-fontawesome.umd.min.js
   |__ng-fontawesome.bundle.min.js.map
|__index.d.ts
|__package.json
|__README.md
|__*.d.ts
|__ng-fontawesome.d.ts
|__ng-fontawesome.module.d.ts
|__ng-fontawesome.es5.js
|__ng-fontawesome.es5.js.map
|__ng-fontawesome.js
|__ng-fontawesome.js.map
|__ng-fontawesome.metadata.json
```
